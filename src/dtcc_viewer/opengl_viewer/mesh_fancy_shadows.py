...
class MeshShadow:
    ...
    def _render_shadow_map(self, time):    
        ...
        #self.model_loc_shadow = glGetUniformLocation(self.shader_shadow_map, "model")        
    ...
    def _render_model_with_shadows(self, interaction:Interaction):
        ...
        glUseProgram(self.shader_fancy_shadows)
        #self.lsm_loc_fancy_shadows = glGetUniformLocation(self.shader_fancy_shadows, "light_space_matrix")
        #self.model_loc = glGetUniformLocation(self.shader_fancy_shadows, "model")
        ...
        #Set light uniforms
        glUniform3f(self.lc_loc_fancy_shadows, self.light_color[0], self.light_color[1], self.light_color[2])
        glUniform3f(self.vp_loc_fancy_shadows, interaction.camera.camera_pos[0], interaction.camera.camera_pos[1], interaction.camera.camera_pos[2])
        glUniform3f(self.lp_loc_fancy_shadows, self.light_position[0], self.light_position[1], self.light_position[2])
    ...
    def render_fancy(self, time, interaction:Interaction):
        ...
        glUniform3f(self.vp_loc_fancy_shadows, view_pos[0], view_pos[1], view_pos[2])

        #Set light uniforms
        glUniform3f(self.lc_loc_fancy, self.light_color[0], self.light_color[1], self.light_color[2])
        glUniform3f(self.lp_loc_fancy, self.light_position[0], self.light_position[1], self.light_position[2])
