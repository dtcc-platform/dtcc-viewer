...
class PointCloudData:
    ...
    def move_pc_to_origin(self, points: np.ndarray, pc:PointCloud, mesh_avrg_pt:np.ndarray = None):
    ...
    def move_pc_to_origin_multi(self, points: np.ndarray, recenter_vec:np.ndarray = None):
