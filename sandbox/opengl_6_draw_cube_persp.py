...
translate = pyrr.matrix44.create_from_translation(pyrr.Vector3([0, 0, -5]))
...
while not glfw.window_should_close(window):
    ...
    rotate = pyrr.matrix44.multiply(rot_x, rot_y)
    model = pyrr.matrix44.multiply(rotate, translate)
